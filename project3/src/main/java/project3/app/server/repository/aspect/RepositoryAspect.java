package project3.app.server.repository.aspect;
...
public class RepositoryAspect {
    ...
    @Pointcut("execution(* project3.app.server.repository..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* project3.app.server.repository..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* project3.app.server.repository..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* project3.app.server.repository..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* project3.app.server.repository..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* project3.app.server.repository..*(..))")
