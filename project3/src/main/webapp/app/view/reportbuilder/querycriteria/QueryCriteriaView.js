Ext.define('Project3.view.reportbuilder.querycriteria.QueryCriteriaView', {
	extend : 'Ext.grid.Panel',
	requires:['Project3.view.reportbuilder.querycriteria.QueryCriteriaController',
	          'Project3.store.QueryCriteriaWidgetsStore',
	          'Ext.grid.RowEditor',
	          'Project3.view.reportbuilder.querycriteria.QueryCriteriaModel'
	          ],
	...
	columns : [
				...
				},
				{
					...
					editor : {
						...
						store : 'Project3.store.QueryCriteriaWidgetsStore',
						queryMode : 'local',
						forceSelection : true,
						triggerAction : 'all',
						selectOnFocus : true,
