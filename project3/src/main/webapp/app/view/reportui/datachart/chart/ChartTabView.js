Ext.define('Project3.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Project3.view.reportui.datachart.chart.RatingField','Project3.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
