Ext.define('Project3.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Project3.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Project3.view.querybuildernewmodel.queryentitiesjoins.Query',
			          'Project3.view.querybuildernewmodel.floatingentity.EntitySprite',
