Ext.define('Project3.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Project3.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Project3.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Project3.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Project3.view.querybuildernewmodel.querydetail.QueryDetail');
