Ext
		.define(
				'Project3.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Project3.view.searchengine.search.SearchEngineMainPanelController','Project3.view.searchengine.search.PanelHeaderField' ,'Project3.view.searchengine.search.ReportGridView','Project3.view.searchengine.search.ReportChartView','Project3.view.searchengine.search.documentView','Project3.view.searchengine.search.DouMeanView','Project3.view.googlemaps.map.MapPanel'],
