Ext.define('Project3.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Project3.view.usermanagement.admin.AddUserDetailsViewModel', 'Project3.model.AddUserDataModel' ],
