...
public class UserTestCase {
    ...
    public void test1Save() {
        try {
            ...
            useraccessdomain.setDomainDescription("SOiAjKxhNh2bX6dwcykyzePQGjgcweVA21GH7Pr5XOr9r5wCJO");
            useraccessdomain.setDomainHelp("Aglcijjj0AukqDrw2PD5K5TuE0n566MFV3g7BKHMyqgOxEPdAI");
            useraccessdomain.setDomainIcon("tU8aablYIDpObsVlBAXsFUgEbOrByJSs0iPkBTyXsQv3ULYqiH");
            useraccessdomain.setDomainName("XQBHcWJ2Vsqom3HbWck7SjeKePgKlo8cmdFKfKY1XRXof9zIAS");
            useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
            UserAccessDomain UserAccessDomainTest = useraccessdomainRepository.save(useraccessdomain);
            map.put("UserAccessDomainPrimaryKey", useraccessdomain._getPrimarykey());
            UserAccessLevel useraccesslevel = new UserAccessLevel();
            useraccesslevel.setLevelDescription("h6jsGrbFNpyepGEQec0EQClH6ADWTYGXtiX9egYF87z8VScr7v");
            useraccesslevel.setLevelHelp("TuCroz5PIvPpGUYpLzAoX9uHZ9P5rrgfdSsflo6f3cwFCYvTFu");
            useraccesslevel.setLevelIcon("0p9CJFiD6lpm6llqcJVSdkWeRL84VRTzzHCcz9izqadJNkqjTq");
            useraccesslevel.setLevelName("90Q9foNKXl5M4tBnM3ZKSDOByRoSsZAfdQWsnOVZhk0GyQNE3D");
            ...
            user.setPasswordAlgo("cRDOMJtA32DNMGb2nP8clgGgPX3OunA9GpIU2vTOgksAaAGVDz");
            user.setPasswordExpiryDate(new java.sql.Timestamp(123456789));
            user.setSessionTimeout(1389);
            user.setUserAccessCode(11);
            user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
            user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
            java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
            PassRecovery passrecovery = new PassRecovery();
            passrecovery.setAnswer("JlWTdX4sJhPrHto9Zmi7ZYFsO7pJUcmWboW9KBmB31tjG545jt");
            Question question = new Question();
            question.setLevelid(4);
            question.setQuestion("gNrXnmTkXyLzCziWZN3OQJ2pir6jFSnomXFdN4nhB97h85iBtx");
            question.setQuestionDetails("u62");
            question.setQuestionIcon("hC4jyjXeaqJJSo7QJil7JmIamkYw2aWuqzNFT0Z86hhSta6COM");
            Question QuestionTest = questionRepository.save(question);
            map.put("QuestionPrimaryKey", question._getPrimarykey());
            passrecovery.setAnswer("0c2hxokGcu1AIpFjEg0v3qjVfg5gGz07e5AzCvQWD6JxGE9Myn");
