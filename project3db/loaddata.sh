...
$MYSQL/mysql --local-infile=1 -h$HOST -p$PORT -u$USER -p$PASSWORD $DB_NAME -e "load data local infile '$ART_DATA_PATH/art_log_events_t.csv' into table art_log_events_t FIELDS TERMINATED BY '#appfire#' LINES TERMINATED BY '\n' ";
