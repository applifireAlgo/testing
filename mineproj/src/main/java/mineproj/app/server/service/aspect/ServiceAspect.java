package mineproj.app.server.service.aspect;
...
public class ServiceAspect {
    ...
    @Pointcut("execution(* mineproj.app.server.service..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* mineproj.app.server.service..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* mineproj.app.server.service..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* mineproj.app.server.service..*..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* mineproj.app.server.service..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* mineproj.app.server.service..get*(..))")
