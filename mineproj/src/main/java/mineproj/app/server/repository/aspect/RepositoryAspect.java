package mineproj.app.server.repository.aspect;
...
public class RepositoryAspect {
    ...
    @Pointcut("execution(* mineproj.app.server.repository..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* mineproj.app.server.repository..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* mineproj.app.server.repository..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* mineproj.app.server.repository..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* mineproj.app.server.repository..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* mineproj.app.server.repository..*(..))")
