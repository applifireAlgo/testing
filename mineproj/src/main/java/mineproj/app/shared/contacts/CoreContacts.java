package mineproj.app.shared.contacts;
...
import mineproj.app.shared.EntityAudit;
import mineproj.app.shared.SystemInfo;
...
public class CoreContacts implements Serializable, CommonEntityInterface, CoreContactsInterface, Comparator<CoreContacts> {
    ...
    public CoreContacts addCommunicationData(CommunicationData _communicationData) {
        if (this.communicationData == null) {
            this.communicationData = new java.util.ArrayList<mineproj.app.shared.contacts.CommunicationData>();
        }
    ...
    public CoreContacts addAddress(Address _address) {
        if (this.address == null) {
            this.address = new java.util.ArrayList<mineproj.app.shared.location.Address>();
        }
        if (_address != null) {
    ...
    public boolean equals(Object obj) {
        try {
            mineproj.app.shared.contacts.CoreContacts other = (mineproj.app.shared.contacts.CoreContacts) obj;
            if (contactId == null) {
                return false;
