...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Village", complexity = Complexity.LOW)
...
public class Village implements Serializable, CommonEntityInterface, Comparator<Village> {
    ...
    public boolean equals(Object obj) {
        try {
            mineproj.app.shared.location.Village other = (mineproj.app.shared.location.Village) obj;
            if (villageId == null) {
                return false;
