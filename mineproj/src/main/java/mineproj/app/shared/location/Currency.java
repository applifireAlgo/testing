...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Currency", complexity = Complexity.LOW)
...
public class Currency implements Serializable, CommonEntityInterface, Comparator<Currency> {
    ...
    public boolean equals(Object obj) {
        try {
            mineproj.app.shared.location.Currency other = (mineproj.app.shared.location.Currency) obj;
            if (currencyId == null) {
                return false;
