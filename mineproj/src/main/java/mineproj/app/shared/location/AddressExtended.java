package mineproj.app.shared.location;
...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "AddressExtended", complexity = Complexity.LOW)
...
public class AddressExtended implements Serializable, CommonEntityInterface, Comparator<AddressExtended> {
    ...
    public boolean equals(Object obj) {
        try {
            mineproj.app.shared.location.AddressExtended other = (mineproj.app.shared.location.AddressExtended) obj;
            if (addExtId == null) {
                return false;
