 ...
 * 
 */
Ext.define('Mineproj.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Mineproj.view.logalarm.mainscreen.AddLogAlarmController',
			'Mineproj.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Mineproj.view.logalarm.mainscreen.AppAlarmPanel',
