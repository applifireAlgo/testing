Ext.define('Mineproj.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Mineproj.view.usermanagement.enduser.UserProfileController', 'Mineproj.view.usermanagement.admin.AddUserDetailsViewModel', 'Mineproj.model.AddUserDataModel' ],
