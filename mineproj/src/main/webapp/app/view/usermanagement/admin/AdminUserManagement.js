Ext.define('Mineproj.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Mineproj.view.usermanagement.admin.UserPasswordReset',
	            'Mineproj.view.usermanagement.admin.AddUserDetails',
	            'Mineproj.view.usermanagement.admin.ViewUser'],
