Ext.define('Mineproj.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Mineproj.view.usermanagement.admin.AddUserDetailsViewModel', 'Mineproj.model.AddUserDataModel' ],
