Ext.define('Mineproj.view.mainleftmenutree.MainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'mainPanelWithLeftMenu',

	requires : [ 'Mineproj.view.resource.ResourcePanel',
			'Mineproj.view.mainleftmenutree.TopPanel.TopPanel',
			'Ext.layout.container.Accordion', 'Ext.Img', 'Ext.button.Split',
			'Mineproj.view.resource.DockedResourcePanel','Mineproj.view.fw.mainViewPanel.MainPanelController' ],
