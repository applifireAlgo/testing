Ext.define('Mineproj.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Mineproj.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Mineproj.view.reportbuilder.gridconfig.GridConfigView',
	           'Mineproj.view.reportbuilder.properties.PropertiesPanelView',
	           'Mineproj.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
