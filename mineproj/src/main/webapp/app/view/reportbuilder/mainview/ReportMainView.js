Ext.define('Mineproj.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Mineproj.view.reportbuilder.reportlist.ReportListPanelView',
             'Mineproj.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Mineproj.view.reportbuilder.mainview.ReportMainController'
             ],
