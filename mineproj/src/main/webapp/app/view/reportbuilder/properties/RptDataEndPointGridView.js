Ext.define('Mineproj.view.reportbuilder.properties.RptDataEndPointGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Mineproj.view.reportbuilder.properties.RptDataEndPointGridController'],
