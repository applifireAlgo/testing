Ext.define('Mineproj.view.reportbuilder.querycriteria.QueryCriteriaView', {
	extend : 'Ext.grid.Panel',
	requires:['Mineproj.view.reportbuilder.querycriteria.QueryCriteriaController',
	          'Mineproj.store.QueryCriteriaWidgetsStore',
	          'Ext.grid.RowEditor',
	          'Mineproj.view.reportbuilder.querycriteria.QueryCriteriaModel'
	          ],
	...
	columns : [
				...
				},
				{
					...
					editor : {
						...
						store : 'Mineproj.store.QueryCriteriaWidgetsStore',
						queryMode : 'local',
						forceSelection : true,
						triggerAction : 'all',
						selectOnFocus : true,
