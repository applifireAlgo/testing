...
Ext
		.define(
				'Mineproj.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
				{
					...
					requires : [ 'Mineproj.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTabController' ],
