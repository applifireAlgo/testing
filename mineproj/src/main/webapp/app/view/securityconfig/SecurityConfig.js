 ...
 * 
 */
Ext.define('Mineproj.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Mineproj.view.securityconfig.SecurityConfigController',
			'Mineproj.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
