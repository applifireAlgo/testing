Ext.define('Mineproj.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Mineproj.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Mineproj.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Mineproj.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Mineproj.view.querybuildernewmodel.querydetail.QueryDetail');
