Ext.define('Mineproj.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Mineproj.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Mineproj.view.querybuildernewmodel.queryentitiesjoins.Query',
			          'Mineproj.view.querybuildernewmodel.floatingentity.EntitySprite',
