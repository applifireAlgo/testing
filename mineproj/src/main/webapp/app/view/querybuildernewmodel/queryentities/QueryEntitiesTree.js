Ext.define('Mineproj.view.querybuildernewmodel.queryentities.QueryEntitiesTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Mineproj.view.querybuildernewmodel.queryentities.QueryEntitiesController'],
