Ext
		.define(
				'Mineproj.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Mineproj.view.searchengine.search.SearchEngineMainPanelController','Mineproj.view.searchengine.search.PanelHeaderField' ,'Mineproj.view.searchengine.search.ReportGridView','Mineproj.view.searchengine.search.ReportChartView','Mineproj.view.searchengine.search.documentView','Mineproj.view.searchengine.search.DouMeanView','Mineproj.view.googlemaps.map.MapPanel'],
