Ext.define('Mineproj.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Mineproj.view.reportui.datachart.chart.RatingField','Mineproj.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
