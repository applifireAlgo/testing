...
Ext.define('Mineproj.view.reportui.datachart.chart.RatingField', {
	...
	onRender: function(ct, position) {
		Mineproj.view.reportui.datachart.chart.RatingField.superclass.onRender.call(this, ct, position);
	 ...
	 */
	initEvents: function() {
		Mineproj.view.reportui.datachart.chart.RatingField.superclass.initEvents.call(this);
