...
public class UserTestCase {
    ...
    public void test1Save() {
        try {
            ...
            useraccessdomain.setDomainDescription("zfoXTzOtJPNQ8pItsvtJYoEXmRpOroCOqEYaIrwpFO6vkyU7WE");
            useraccessdomain.setDomainHelp("XlhF6EHyy2Ila133GEGUkB79Uq2Lfrk35U06tI2BpuBWdcmkxc");
            useraccessdomain.setDomainIcon("ObWDqqdKH1tImGCLv0UtkfJhM2NRHuNOdSwlzfhXUQCGbQuBcu");
            useraccessdomain.setDomainName("sxifMsQWR9pNJ55gVJD9KfLVdvRXQ7j2r0q50lNZ9u7JXWow91");
            useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
            UserAccessDomain UserAccessDomainTest = useraccessdomainRepository.save(useraccessdomain);
            map.put("UserAccessDomainPrimaryKey", useraccessdomain._getPrimarykey());
            UserAccessLevel useraccesslevel = new UserAccessLevel();
            useraccesslevel.setLevelDescription("VyaLm1bJtJLiQ7In6vH5ZrbUFwlY9TYnG63KGqn0Ag7y7s1bUF");
            useraccesslevel.setLevelHelp("hAG582DqnyzrJC76XQ6HR9sjWOQYJKNqCYkApsEs7MNE9gEYqr");
            useraccesslevel.setLevelIcon("8jyI38AxXlkFU22HBmP0QpnXzCRJm6OnnzMSTptv8YlnNV8jPP");
            useraccesslevel.setLevelName("1UGjBjHs6yUUfFMEaOVDBVQewY00mt0Ua0ReXICi1Gj0VAJOsp");
            ...
            user.setPasswordAlgo("1FlILyLYf1RZUajLmmVsOEL7deibDNiFXVmglxMdGZjIiZr0Hk");
            user.setPasswordExpiryDate(new java.sql.Timestamp(123456789));
            user.setSessionTimeout(21);
            user.setUserAccessCode(4);
            user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
            user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
            java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
            PassRecovery passrecovery = new PassRecovery();
            passrecovery.setAnswer("9gkvztYVFLbFQzxifMHKTSFRM1X6WFxuTXwZiungfEbIiUcWYR");
            Question question = new Question();
            question.setLevelid(11);
            question.setQuestion("xDaGfhvr3UpRS3f0mQSAje2tueSO9Ycm1SeZMuCvALYy0khnEQ");
            question.setQuestionDetails("YK2");
            question.setQuestionIcon("pQS5MjU2td4NIzZOiMbZuGcg8kgamXtpQ0wXZmUg9uUaPID1g2");
            Question QuestionTest = questionRepository.save(question);
            map.put("QuestionPrimaryKey", question._getPrimarykey());
            passrecovery.setAnswer("tivlAOM8zp48EhNG70G2kmnz2Vw7GpaC32qOPfE7wQo40rpPM7");
